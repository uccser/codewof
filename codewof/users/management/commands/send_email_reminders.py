    ...
    <footer>
        <div style="border-top: 2px solid #eaeaea;">
            ...
            <p style="font-size: 16px; font-weight: 400; line-height: 24px;">
                You received this email because you opted into reminders. You can <a href="https://litmus.com/community" style="color: #007bff; text-decoration: underline;">change your reminder settings here</a>.
            </p>
        </div>
    </footer>
